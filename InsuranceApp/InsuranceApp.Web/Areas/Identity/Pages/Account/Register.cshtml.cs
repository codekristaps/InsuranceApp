...
namespace InsuranceApp.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            // checking if the database has roles present
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // let's add the selected role with the select at the register
        ...
        private InsuranceCustomer CreateUser()
        {
            try
            {
                return Activator.CreateInstance<InsuranceCustomer>();
            }
            catch
            {
